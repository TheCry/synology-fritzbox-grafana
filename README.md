...
![alt text](https://github.com/TheCry/synology-fritzbox-grafana/blob/master/images/dashboard.png)
...
![alt text](https://github.com/TheCry/synology-fritzbox-grafana/blob/master/images/grafana-fitzbox.jpg)
...
![alt text](https://github.com/TheCry/synology-fritzbox-grafana/blob/master/images/synology-folder-2.JPG)

## Create collectd FRITZ!Box Router file
1. Create a file with the FRITZ!Box user login data (Template: https://github.com/TheCry/synology-fritzbox-grafana/blob/master/collectd-fritzbox/fritzcollectd.conf)
...
![alt text](https://github.com/TheCry/synology-fritzbox-grafana/blob/master/images/start-container_extended_volumes.JPG)
...
![alt text](https://github.com/TheCry/synology-fritzbox-grafana/blob/master/images/start-container_extended_ports.JPG)
